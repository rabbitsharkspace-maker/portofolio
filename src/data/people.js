  ...
  jane: {
    ...
    en: {
      ...
      background: [
        ...
        { kind: "creative", text: "Snaptrek / Pop Sushi / Hotmart / Hi Fumi — Brand visuals & short video" },
        { kind: "community", text: "RMIT Student Ambassador, Peer Mentor, SSCC Student Representative" },
        { kind: "community", text: "Australian Red Cross, Gapper Aus committee" },
      ],
    ...
    zh: {
      ...
      background: [
        { kind: "business", text: "RMIT University｜商业学士，区块链商业方向 · 2022–2024" },
        { kind: "business", text: "云辰期货｜市场研究实习 · 2023–2024" },
        { kind: "business", text: "中国船舶｜业务员 · 2023" },
        { kind: "business", text: "Intelligent Health Systems｜市场实习 · 2024" },
        { kind: "tech", text: "HTP Smart Energy｜并网申请、网站维护与设计" },
        { kind: "community", text: "Dovida｜老年居家照护" },
        { kind: "creative", text: "Snaptrek / Pop Sushi / Hotmart / Hi Fumi｜品牌视觉与短视频" },
        { kind: "community", text: "RMIT University｜学生大使、朋辈导师、SSCC 学生代表" },
        { kind: "community", text: "Australian Red Cross｜志愿者；Gapper Aus｜委员会成员" },
      ],
