...
const OptionWheel = ({
  ...
  useEffect(
    () => () => {
      // Null the handle after cancelling. StrictMode mounts, unmounts, then
      // remounts in dev; if the cancelled frame's id were left in place,
      // startLoop's `already running?` guard would see it and never reschedule,
      // leaving every option stuck unpositioned at dead centre.
