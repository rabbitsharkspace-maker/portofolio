...
const ILLUSTRATIONS = [
  ...
  },
  {
    ...
    image: '/kawaii_illustration.jpeg'
  },
  {
...
const POSTERS = [
  ...
  },
  {
    ...
    image: '/fashion_editorial.jpeg'
  }
];

const RESOURCES = [
  { name: 'MeBumi: Branding & Digital Communications Strategy', path: '/mebumi_strategy.pdf' },
  { name: 'Shell: Sustainable Offshore Repurposing Strategy', path: '/shell_strategy.pdf' },
  { name: 'Nibou: Nurturing Sustainability Initiatives Strategy', path: '/nibou_sustainability.pdf' },
  { name: 'ACQUABOSS: Summer Accessories Catalogue', path: '/acquaboss_product_catalogue.pdf' },
  { name: 'Mozzigear: Outdoor Lifestyle Catalogue', path: '/mozzigear_catalogue.pdf' },
  { name: 'Armor Trailer: Heavy Duty Trailer Catalogue', path: '/armor_trailers.pdf' },
];
          ...
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4 h-[600px]">
              <div className="space-y-4 pt-12">
                <img src="/camp_1.jpg" alt="About 1" className="w-full h-[300px] object-cover rounded-xl shadow-lg" />
                <img src="/hot_pot.jpg" alt="About 2" className="w-full h-full object-cover rounded-xl shadow-lg" />
              </div>
              <div className="space-y-4">
                <img src="/camp_poster.jpg" alt="About 3" className="w-full h-full object-cover rounded-xl shadow-lg" />
