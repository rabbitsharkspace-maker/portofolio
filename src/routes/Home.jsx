...
export default function Home() {
  ...
  return (
    <>
      ...
      <Section label={T.recognition} title={st.recognition.event}>
        <div className="max-w-[820px] border-l-4 pl-5" style={{ borderColor: GREEN }}>
          <p className="text-[17px] leading-relaxed">{st.recognition.path}</p>
          <p className="mt-3 text-[14px] leading-relaxed" style={{ color: "var(--dim)" }}>
            {st.recognition.awards}
          </p>
        </div>
      </Section>
