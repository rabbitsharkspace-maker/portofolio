  ...
  return <section className="playful-hero">
    <div className="playful-hero-copy">
      ...
      <div className="hero-duo">
        <Mascot species="rabbit" spark="var(--jenny)" label={zh ? 'Jane，那只兔子' : 'Jane, the rabbit'} />
        <Mascot species="shark" spark="var(--jane)" label={zh ? 'Jenny，那条鲨鱼' : 'Jenny, the shark'} />
        <span className="hero-duo-note">{zh ? '戳一下，它们有反应。' : 'go on — poke them.'}</span>
      </div>
